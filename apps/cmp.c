...
"Intermediate certificates for constructing chains for CMP, TLS, and/or issuer"},
...
"0 = NONE, 1 = SIGNATURE, 2 = ENCRCERT, 3 = RAVERIFIED. Default 1 = SIGNATURE"},
    ...
    {OPT_MORE_STR, 0, 0,
"also used as reference (for IR/CR, defaults to -cert) for subject DN and SANs."},
    {OPT_MORE_STR, 0, 0,
...
"Use given CRL(s) as secondary (fallback) source when verifying certs."},
    {OPT_MORE_STR, 0, 0,
"URL may start with 'http:' or point to local file (can be prefixed by 'file:')"},
    {OPT_MORE_STR, 0, 0,
