...
CMP_CTX_set0_crls() sets CRLs to be used as primary source during CMP certificate verification.

CMP_CTX_set_cdp_callback() sets callback function for CRL retrieval 
to be used as secondary source during CMP certificate verification.
