...
=head1 SYNOPSIS
 ...
 int CMP_CTX_set0_untrusted_certs( CMP_CTX *ctx, STACK_OF (X509) *store);
...
CMP_CTX_set0_untrusted_certs() sets the list of certificates
