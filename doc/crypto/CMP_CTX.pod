...
CMP_CTX_delete(), CMP_printf() do not return anything.
...
CMP_CTX_get0_newClCert() returns the received (in IP/KUP/CP) client certificate
from the context. NULL if there was none as well as on error.
