...
=head1 SYNOPSIS
  ...
  CMP_PKISTATUSINFO *CMP_REVREPCONTENT_status_get(CMP_REVREPCONTENT *rrep, long rsid);
...
CMP_REVREPCONTENT_status_get() returns the status field of the RevRepContent
