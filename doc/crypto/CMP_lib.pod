...
CMP_REVREPCONTENT_PKIStatus_get() returns the PKIStatus of the status appearing
at the given id in the sequence (matching the sequence id as sent in the
RevReqContent), or -1 on error.
