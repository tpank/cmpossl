...
Distinguished Name of the recipient, i.e. the CMP server the request is sent to.
Defaults to the subject name of the CA certificate if option is given.
For RR, defaults to the subject name of the issuer of the certificate to be revoked.
If neither srvcert is given nor RR is tdone, then the recipient name option is mandatory.
