...
=item B<-extracerts filename>

File or URL with certificates to include in the extraCerts field of requests.
...
B<-untrusted>, B<-out-trusted>, B<-extracerts>, or B<-tls-trusted> options.
If not given here, the password will be prompted for if needed.
