...
May be set alternatively to the B<-trusted> option if the certificate is
available and should be directly trusted.

If set, the issuer of the certificate is also used as the recipient of the CMP
message, overriding any potential B<-recipient> option.
