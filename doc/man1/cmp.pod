...
are copied from the reference certificate (see B<-oldcert>).
...
Flag the Subject Alternative Name(s) given with B<-san_dns> or B<-san_ip>
as critical.

=item B<-san_nodefault>

Do not take default Subject Alternative Name(s) from the reference certificate.
