...
BIO_wait() waits on the socket underlying the given B<bio>, for read if B<bio>
is supposed to read, else for write, at most until B<max_time>.
...
returs -1 on error, 0 on timeout, and 1 on success.
