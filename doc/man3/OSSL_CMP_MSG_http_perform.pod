...
specified in ctx. On success (return 1), assigns the server's response to *res.
...
OSSL_CMP_MSG_http_perform() returns 1 on success,
OSSL_CMP_ERROR_TRANSFERRING_OUT on send error,
