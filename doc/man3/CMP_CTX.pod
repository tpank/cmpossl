...
RFC 4210.
    ...
    CMP_CTX_OPT_IGNORE_KEYUSAGE
        Ignore CMP-level certificate key usage extension in certificate used for
        validating signature protecting received CMP messages, if present.
        Else, 'digitalSignature' is asserted.
