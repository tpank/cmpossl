...
RFC 4210.
    ...
    CMP_CTX_OPT_IGNORE_KEYUSAGE
        Ignore CMP-level certificate key usage extension,
        else 'digitalSignature' is required to be present in certificates used
        for validating signatures protecting CMP messages.
