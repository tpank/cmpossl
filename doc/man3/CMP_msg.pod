...
=head1 SYNOPSIS
 ...
 CMP_MSG *CMP_certreq_new(CMP_CTX *ctx, int bodytype, int err_code);
 ...
 OSSL_CMP_MSG *OSSL_CMP_rp_new(OSSL_CMP_CTX *ctx,
                                     ...
                                     int unprotectedErrors);
 CMP_MSG *CMP_certConf_new(CMP_CTX *ctx, int failure, const char *text);
 OSSL_CMP_MSG *OSSL_CMP_pkiconf_new(OSSL_CMP_CTX *ctx);
 CMP_MSG *CMP_pollReq_new(CMP_CTX *ctx, int reqId);
 OSSL_CMP_MSG *OSSL_CMP_pollRep_new(OSSL_CMP_CTX *ctx, long certReqId,
                                          long pollAfter);
 CMP_MSG *CMP_genm_new(CMP_CTX *ctx);
 OSSL_CMP_MSG *OSSL_CMP_genp_new(OSSL_CMP_CTX *ctx);
 CMP_MSG *CMP_error_new(CMP_CTX *ctx, CMP_PKISI *si,
...
All of the functions return a new CMP_MSG structure containing
