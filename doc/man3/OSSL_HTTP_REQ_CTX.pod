...
I<wbio>), and the maximum expected response header line length I<max_line>.
...
of the HTTP client.
If I<keep_alive> is nonzero it cannot be used after calling
OSSL_HTTP_REQ_CTX_set1_req() due to the structure of an HTTP request.
If the parameter I<content_type>
...
If the I<asn1> parameter is nonzero
