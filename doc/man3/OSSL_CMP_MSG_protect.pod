...
OSSL_CMP_PKIHEADER_generalInfo_item_push0,
OSSL_CMP_MSG_generalInfo_items_push1,
OSSL_CMP_PKIHEADER_push0_freeText,
OSSL_CMP_PKIHEADER_push1_freeText,
OSSL_CMP_MSG_get0_header,
OSSL_CMP_PKIHEADER_get0_transactionID,
OSSL_CMP_PKIHEADER_get0_senderNonce,
OSSL_CMP_PKIHEADER_get0_recipNonce,
OSSL_CMP_PKIHEADER_init,
OSSL_CMP_PKIHEADER_set1_recipient,
OSSL_CMP_PKIHEADER_set1_sender,
OSSL_CMP_PKIHEADER_set1_senderKID,
OSSL_CMP_PKIHEADER_set_messageTime,
OSSL_CMP_PKIHEADER_set_pvno,
OSSL_CMP_PKIHEADER_get_pvno,
...
OSSL_CMP_PKIHEADER_generalInfo_item_push0() adds the given InfoTypeAndValue
...
OSSL_CMP_PKIHEADER_push0_freeText() pushes an ASN1_UTF8STRING to
hdr->freeText and consumes the given pointer.

OSSL_CMP_PKIHEADER_push1_freeText() pushes an ASN1_UTF8STRING to
hdr->freeText and does not consume the pointer.

OSSL_CMP_MSG_get0_header returns the header of the given CMP message.

OSSL_CMP_PKIHEADER_get0_transactionID returns the transaction ID of the given
PKIHeader.

OSSL_CMP_PKIHEADER_get0_senderNonce returns the sender nonce of the given PKIHeader.

OSSL_CMP_PKIHEADER_get0_recipNonce returns the recipient nonce of the given PKIHeader.

OSSL_CMP_PKIHEADER_init() initializes a PKIHeader structure based on the
values in the given OSSL_CMP_CTX structure.

OSSL_CMP_PKIHEADER_set1_recipient() sets the recipient field in the given
PKIHeader to the given X509 Name value, without consuming the pointer.

OSSL_CMP_PKIHEADER_set1_sender() sets the sender field in the given PKIHeader
to the given X509 Name value, without consuming the pointer.

OSSL_CMP_PKIHEADER_set1_senderKID() Sets hdr->senderKID to the given
...
OSSL_CMP_PKIHEADER_set_messageTime() sets the messageTime to the current system time.

OSSL_CMP_PKIHEADER_set_pvno() sets hdr->pvno to the given B<pvno>.

OSSL_CMP_PKIHEADER_get_pvno() returns the pvno of the given B<hdr> or -1 on error.
...
L<OSSL_CMP_CTX_new(3)>, L<OSSL_CMP_exec_IRses(3)>,
