...
=head1 SYNOPSIS
 ...
 OCSP_REQ_CTX *OSSL_HTTP_open(const char *server, const char *port,
                              const char *path, int use_ssl,
                              const char *proxy, const char *no_proxy,
                              BIO *bio, BIO *rbio,
                              OSSL_HTTP_bio_cb_t bio_update_fn, void *arg,
 ...
 BIO *OSSL_HTTP_transfer(OCSP_REQ_CTX *rctx, char **redirection_url);
 ASN1_VALUE *OSSL_HTTP_transfer_asn1(OCSP_REQ_CTX *rctx,
                                     const char *path,
                                     const STACK_OF(CONF_VALUE) *headers,
                                     const char *content_type,
 ...
 int OSSL_HTTP_close(OCSP_REQ_CTX *rctx, int ok);
