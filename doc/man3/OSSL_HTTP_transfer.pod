...
The I<max_line> parameter specifies the response header maximum line length.
...
OSSL_HTTP_is_alive() returns 1 if the client requested a persistent connection
