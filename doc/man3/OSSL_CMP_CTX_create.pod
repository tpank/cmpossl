...
OSSL_CMP_CTX_new() allocates and initialized an OSSL_CMP_CTX structure.
...
RFC 4210.
    ...
    OSSL_CMP_OPT_UNPROTECTED_REQUESTS
...
certificate response message IP/CP/KUP.
...
OSSL_CMP_CTX_new() returns a pointer to an initialized
OSSL_CMP_CTX structure.
