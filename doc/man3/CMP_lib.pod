...
=head1 NAME
  ...
  CMP_PKIMESSAGE_adapt_senderNonce_transactionID,
...
CMP_PKIMESSAGE_adapt_senderNonce_transactionID() copies the recipNonce of the
src to the senderNonce of the msg and copies the transactionID from src to msg.
