...
=head1 SYNOPSIS
  ...
  int CMP_PKIMESSAGE_generalInfo_items_push1(CMP_PKIMESSAGE *msg, STACK_OF(CMP_ITAV) *itavs);
  ...
  int CMP_PKIMESSAGE_genm_item_push0(CMP_PKIMESSAGE *msg, const CMP_ITAV *itav);
  int CMP_PKIMESSAGE_genm_items_push1(CMP_PKIMESSAGE *msg, STACK_OF(CMP_ITAV) *itavs);
  ...
  ASN1_BIT_STRING *OSSL_CMP_calc_protection(const CMP_PKIMESSAGE *msg,
