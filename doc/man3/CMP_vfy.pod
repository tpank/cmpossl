...
=head1 SYNOPSIS
 ...
 int CMP_validate_msg(CMP_CTX *ctx, CMP_MSG *msg);
...
CMP_expired() is a helper function checking if expiration should be checked
...
CMP_expired() returns 1 if expiration should be checked
