...
with the given values. Status is set to B<status>. If B<failInfo> >0 sets
failinfo bit with index B<failInfo-1>. Sets statusString to B<text>.  It returns
a pointer to the structure on success, NULL on error.
