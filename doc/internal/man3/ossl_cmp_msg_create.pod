...
ossl_cmp_msg_create,
ossl_cmp_msg_load,
ossl_cmp_msg_gen_Iitav_push0,
ossl_cmp_msg_gen_Iitavs_push1
...
=head1 SYNOPSIS
  ...
  int ossl_cmp_msg_gen_Iitav_push0(OSSL_CMP_MSG *msg, OSSL_CMP_ITAV *itav);
  int ossl_cmp_msg_gen_Iitavs_push1(OSSL_CMP_MSG *msg,
...
ossl_cmp_msg_gen_Iitav_push0() pushes the B<itav> to the body of the
PKIMessage B<msg> of GenMsg or GenRep type. Consumes the B<itavs> pointer.
Returns 1 on success, 0 on error.

ossl_cmp_msg_gen_Iitavs_push1() adds a copy of the B<itavs> stack to the body
