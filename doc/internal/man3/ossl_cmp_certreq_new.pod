...
# define OSSL_CMP_PKIBODY_POLLREP  26
 ...
 OSSL_ossl_cmp_MSG *CMP_certreq_new(OSSL_CMP_CTX *ctx, int bodytype, int err_code);
 OSSL_CMP_MSG *ossl_cmp_certrep_new(OSSL_CMP_CTX *ctx, int bodytype,  int certReqId,
