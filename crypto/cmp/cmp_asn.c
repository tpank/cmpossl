...
ASN1_SEQUENCE(CMP_REVANNCONTENT) = {
    ...
    ASN1_SIMPLE(CMP_REVANNCONTENT, certId, OSSL_CRMF_CERTID),
...
ASN1_SEQUENCE(CMP_ERRORMSGCONTENT) = {
    ASN1_SIMPLE(CMP_ERRORMSGCONTENT, pKIStatusInfo, OSSL_CMP_PKISTATUSINFO),
...
ASN1_CHOICE(CMP_CERTORENCCERT) = {
    ...
    ASN1_EXP(CMP_CERTORENCCERT, value.encryptedCert, OSSL_CRMF_ENCRYPTEDVALUE, 1),
...
ASN1_SEQUENCE(CMP_CERTIFIEDKEYPAIR) = {
    ...
    ASN1_EXP_OPT(CMP_CERTIFIEDKEYPAIR, privateKey, OSSL_CRMF_ENCRYPTEDVALUE, 0),
    ASN1_EXP_OPT(CMP_CERTIFIEDKEYPAIR, failInfo, OSSL_CRMF_PKIPUBLICATIONINFO, 1)
} ASN1_SEQUENCE_END(CMP_CERTIFIEDKEYPAIR)
IMPLEMENT_ASN1_FUNCTIONS(CMP_CERTIFIEDKEYPAIR)


ASN1_SEQUENCE(CMP_REVDETAILS) = {
    ASN1_SIMPLE(CMP_REVDETAILS, certDetails, OSSL_CRMF_CERTTEMPLATE),
...
ASN1_SEQUENCE(CMP_REVREPCONTENT) = {
    ASN1_SEQUENCE_OF(CMP_REVREPCONTENT, status, OSSL_CMP_PKISTATUSINFO),
    ASN1_EXP_SEQUENCE_OF_OPT(CMP_REVREPCONTENT, certId, OSSL_CRMF_CERTID, 0),
...
ASN1_SEQUENCE(CMP_KEYRECREPCONTENT) = {
    ASN1_SIMPLE(CMP_KEYRECREPCONTENT, status, OSSL_CMP_PKISTATUSINFO),
...
ASN1_SEQUENCE(OSSL_CMP_PKISTATUSINFO) = {
    ASN1_SIMPLE(OSSL_CMP_PKISTATUSINFO, status, CMP_PKISTATUS),
    /*
...
ASN1_SEQUENCE(CMP_CERTSTATUS) = {
    ...
    ASN1_OPT(CMP_CERTSTATUS, statusInfo, OSSL_CMP_PKISTATUSINFO)
...
ASN1_SEQUENCE(CMP_CERTRESPONSE) = {
    ...
    ASN1_SIMPLE(CMP_CERTRESPONSE, status, OSSL_CMP_PKISTATUSINFO),
...
ASN1_CHOICE(CMP_PKIBODY) = {
    ASN1_EXP(CMP_PKIBODY, value.ir, OSSL_CRMF_CERTREQMESSAGES, 0),
    ASN1_EXP(CMP_PKIBODY, value.ip, CMP_CERTREPMESSAGE, 1),
    ASN1_EXP(CMP_PKIBODY, value.cr, OSSL_CRMF_CERTREQMESSAGES, 2),
    ...
    ASN1_EXP(CMP_PKIBODY, value.kur, OSSL_CRMF_CERTREQMESSAGES, 7),
    ASN1_EXP(CMP_PKIBODY, value.kup, CMP_CERTREPMESSAGE, 8),
    ASN1_EXP(CMP_PKIBODY, value.krr, OSSL_CRMF_CERTREQMESSAGES, 9),
    ...
    ASN1_EXP(CMP_PKIBODY, value.ccr, OSSL_CRMF_CERTREQMESSAGES, 13),
    ...
    ASN1_EXP(CMP_PKIBODY, value.nested, OSSL_CMP_PKIMESSAGES, 20),
...
ASN1_SEQUENCE(CMP_PROTECTEDPART) = {
    ...
    ASN1_SIMPLE(OSSL_CMP_PKIMESSAGE, body, CMP_PKIBODY)
