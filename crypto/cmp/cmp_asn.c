...
ASN1_SEQUENCE(OSSL_CMP_REVREPCONTENT) = {
    ...
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_REVREPCONTENT, revCert, OSSL_CRMF_CERTID, 0),
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_REVREPCONTENT, crl, X509_CRL, 1)
...
ASN1_SEQUENCE(OSSL_CMP_KEYRECREPCONTENT) = {
    ...
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_KEYRECREPCONTENT, keyPairHist, OSSL_CMP_CERTORENCCERT, 2)
