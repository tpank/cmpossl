...
ASN1_ITEM_TEMPLATE(OSSL_CMP_POPODECKEYCHALLCONTENT) =
    ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_POPODECKEYCHALLCONTENT,
            OSSL_CMP_CHALLENGE)
ASN1_ITEM_TEMPLATE_END(OSSL_CMP_POPODECKEYCHALLCONTENT)


ASN1_ITEM_TEMPLATE(OSSL_CMP_POPODECKEYRESPCONTENT) =
    ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_POPODECKEYRESPCONTENT,
            ASN1_INTEGER)
...
ASN1_SEQUENCE(OSSL_CMP_ERRORMSGCONTENT) = {
    ASN1_SIMPLE(OSSL_CMP_ERRORMSGCONTENT, pKIStatusInfo, OSSL_CMP_PKISTATUSINFO),
    ASN1_OPT(OSSL_CMP_ERRORMSGCONTENT, errorCode, ASN1_INTEGER),
    /*
     * OSSL_CMP_REVREPCONTENTOSSL_CMP_PKIFREETEXT is effectively a sequence of ASN1_UTF8STRING so it is
     * used directly
     * */
...
ASN1_CHOICE(OSSL_CMP_CERTORENCCERT) = {
    ...
    ASN1_EXP(OSSL_CMP_CERTORENCCERT, value.encryptedCert, OSSL_CRMF_ENCRYPTEDVALUE, 1),
...
ASN1_SEQUENCE(OSSL_CMP_CERTIFIEDKEYPAIR) = {
    ...
    ASN1_EXP_OPT(OSSL_CMP_CERTIFIEDKEYPAIR, privateKey, OSSL_CRMF_ENCRYPTEDVALUE, 0),
    ASN1_EXP_OPT(OSSL_CMP_CERTIFIEDKEYPAIR, failInfo, OSSL_CRMF_PKIPUBLICATIONINFO, 1)
...
ASN1_SEQUENCE(OSSL_CMP_REVREPCONTENT) = {
    ASN1_SEQUENCE_OF(OSSL_CMP_REVREPCONTENT, status, OSSL_CMP_PKISTATUSINFO),
...
ASN1_SEQUENCE(OSSL_CMP_KEYRECREPCONTENT) = {
    ASN1_SIMPLE(OSSL_CMP_KEYRECREPCONTENT, status, OSSL_CMP_PKISTATUSINFO),
...
ASN1_SEQUENCE(OSSL_CMP_PKISTATUSINFO) = {
    ASN1_SIMPLE(OSSL_CMP_PKISTATUSINFO, status, OSSL_CMP_PKISTATUS),
    /*
     * OSSL_CMP_REVREPCONTENTOSSL_CMP_PKIFREETEXT is effectively a sequence of ASN1_UTF8STRING
     * so it is used directly
     */
    ASN1_SEQUENCE_OF_OPT(OSSL_CMP_PKISTATUSINFO, statusString, ASN1_UTF8STRING),
    /*
     * OSSL_CMP_PKIFAILUREINFO is effectively ASN1_BIT_STRING so it is used directly
     */
    ASN1_OPT(OSSL_CMP_PKISTATUSINFO, failInfo, ASN1_BIT_STRING)
} ASN1_SEQUENCE_END(OSSL_CMP_PKISTATUSINFO)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_PKISTATUSINFO)
IMPLEMENT_ASN1_DUP_FUNCTION(OSSL_CMP_PKISTATUSINFO)
...
ASN1_SEQUENCE(OSSL_CMP_CERTSTATUS) = {
    ...
    ASN1_OPT(OSSL_CMP_CERTSTATUS, statusInfo, OSSL_CMP_PKISTATUSINFO)
...
ASN1_SEQUENCE(OSSL_CMP_CERTRESPONSE) = {
    ...
    ASN1_SIMPLE(OSSL_CMP_CERTRESPONSE, status, OSSL_CMP_PKISTATUSINFO),
...
ASN1_ITEM_TEMPLATE(OSSL_CMP_REVREPCONTENTOSSL_CMP_POLLREPCONTENT) =
    ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_REVREPCONTENTOSSL_CMP_POLLREPCONTENT,
                          OSSL_CMP_POLLREP)
...
ASN1_CHOICE(OSSL_CMP_PKIBODY) = {
    ASN1_EXP(OSSL_CMP_PKIBODY, value.ir, OSSL_CRMF_CERTREQMESSAGES, 0),
    ASN1_EXP(OSSL_CMP_PKIBODY, value.ip, OSSL_CMP_CERTREPMESSAGE, 1),
    ASN1_EXP(OSSL_CMP_PKIBODY, value.cr, OSSL_CRMF_CERTREQMESSAGES, 2),
    ...
    ASN1_EXP(OSSL_CMP_PKIBODY, value.kur, OSSL_CRMF_CERTREQMESSAGES, 7),
    ASN1_EXP(OSSL_CMP_PKIBODY, value.kup, OSSL_CMP_CERTREPMESSAGE, 8),
    ASN1_EXP(OSSL_CMP_PKIBODY, value.krr, OSSL_CRMF_CERTREQMESSAGES, 9),
    ...
    ASN1_EXP(OSSL_CMP_PKIBODY, value.ccr, OSSL_CRMF_CERTREQMESSAGES, 13),
    ...
    ASN1_EXP(OSSL_CMP_PKIBODY, value.nested, OSSL_CMP_PKIMESSAGES, 20),
    ...
    ASN1_EXP(OSSL_CMP_PKIBODY, value.pollRep, OSSL_CMP_REVREPCONTENTOSSL_CMP_POLLREPCONTENT, 26),
...
ASN1_SEQUENCE(CMP_PROTECTEDPART) = {
    ASN1_SIMPLE(OSSL_CMP_PKIMESSAGE, header, OSSL_CMP_PKIHEADER),
    ASN1_SIMPLE(OSSL_CMP_PKIMESSAGE, body, OSSL_CMP_PKIBODY)
} ASN1_SEQUENCE_END(CMP_PROTECTEDPART)
IMPLEMENT_ASN1_FUNCTIONS(CMP_PROTECTEDPART)

ASN1_SEQUENCE(OSSL_CMP_PKIMESSAGE) = {
    ASN1_SIMPLE(OSSL_CMP_PKIMESSAGE, header, OSSL_CMP_PKIHEADER),
    ASN1_SIMPLE(OSSL_CMP_PKIMESSAGE, body, OSSL_CMP_PKIBODY),
    ASN1_EXP_OPT(OSSL_CMP_PKIMESSAGE, protection, ASN1_BIT_STRING, 0),
    /* OSSL_CMP_CMPCERTIFICATE is effectively X509 so it is used directly */
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_PKIMESSAGE, extraCerts, X509, 1)
} ASN1_SEQUENCE_END(OSSL_CMP_PKIMESSAGE)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_PKIMESSAGE)
IMPLEMENT_ASN1_DUP_FUNCTION(OSSL_CMP_PKIMESSAGE)

ASN1_ITEM_TEMPLATE(OSSL_CMP_PKIMESSAGES) =
    ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_PKIMESSAGES,
                          OSSL_CMP_PKIMESSAGE)
ASN1_ITEM_TEMPLATE_END(OSSL_CMP_PKIMESSAGES)
