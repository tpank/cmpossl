...
static const ERR_STRING_DATA CMP_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_PKIHEADER_NEW_SENDERNONCE, 0),
     "CMP_PKIHEADER_new_senderNonce"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_PKIHEADER_SET1_TRANSACTIONID, 0),
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_VERIFY_PBMAC, 9), "CMP_verify_PBMAC"},
...
static const ERR_STRING_DATA CMP_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_CMP, 0, CMP_R_UNABLE_TO_CREATE_CONTEXT), "unable to create context"},
