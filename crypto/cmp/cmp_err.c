...
static const ERR_STRING_DATA CMP_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_ERROR_NEW, 0), "OSSL_OSSL_CMP_error_new"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_POLLREQ_NEW, 0), "OSSL_CMP_pollReq_new"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKISTATUSINFO_PKIFAILUREINFO_GET, 0),
     "OSSL_OSSL_CMP_PKISTATUSINFO_PKIFailureinfo_get"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKISTATUSINFO_PKISTATUS_GET_STRING, 0),
     "OSSL_OSSL_CMP_PKISTATUSINFO_PKIStatus_get_string"},
