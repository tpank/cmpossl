...
static const ERR_STRING_DATA CMP_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_REVREPCONTENT_CERTID_GET, 0),
     "CMP_REVREPCONTENT_CertId_get"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_FIND_VALIDATE_SRVCERT_AND_MSG, 0),
     "find_validate_srvcert_and_msg"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_SET0_NEWCLCERT, 0),
     "OSSL_CMP_CTX_set0_newClCert"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_SET1_OLDCERT, 0),
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIHEADER_GET_PVNO, 0),
     "OSSL_CMP_PKIHEADER_get_pvno"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIHEADER_INIT, 0), "OSSL_CMP_PKIHEADER_init"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIHEADER_SET_PVNO, 0),
