...
static const ERR_STRING_DATA CMP_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_CERTCONF_NEW, 0), "OSSL_CMP_certConf_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_CERTREPMESSAGE_CERTRESPONSE_GET0, 0),
     "CMP_CERTREPMESSAGE_certResponse_get0"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_CERTREP_NEW, 0), "CMP_certrep_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_CERTREQ_NEW, 0), "OSSL_CMP_certreq_new"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_ERROR_NEW, 0), "OSSL_CMP_error_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXCHANGE_CERTCONF, 0),
     "OSSL_CMP_exchange_certConf"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXCHANGE_ERROR, 0),
     "OSSL_CMP_exchange_error"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXEC_CR_SES, 0), "OSSL_CMP_exec_CR_ses"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXEC_GENM_SES, 0),
     "OSSL_CMP_exec_GENM_ses"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXEC_IR_SES, 0), "OSSL_CMP_exec_IR_ses"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXEC_KUR_SES, 0), "OSSL_CMP_exec_KUR_ses"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXEC_P10CR_SES, 0),
     "OSSL_CMP_exec_P10CR_ses"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXEC_RR_SES, 0), "OSSL_CMP_exec_RR_ses"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_GENM_NEW, 0), "OSSL_CMP_genm_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_GENP_NEW, 0), "CMP_genp_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_PKICONF_NEW, 0), "CMP_pkiconf_new"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_POLLREP_NEW, 0), "CMP_pollrep_new"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_RP_NEW, 0), "CMP_rp_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_RR_NEW, 0), "OSSL_CMP_rr_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_VALIDATE_CERT_PATH, 0),
     "OSSL_CMP_validate_cert_path"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_VALIDATE_MSG, 0), "OSSL_CMP_validate_msg"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_ASN1_OCTET_STRING_SET1_BYTES, 0),
     "OSSL_CMP_ASN1_OCTET_STRING_set1_bytes"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CALC_PROTECTION, 0),
     "OSSL_CMP_calc_protection"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CERTCONF_NEW, 0),
     "OSSL_CMP_certConf_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CERTREPMESSAGE_CERTRESPONSE_GET0, 0),
     "CMP_CERTREPMESSAGE_certResponse_get0"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CERTRESPONSE_GET_CERTIFICATE, 0),
     "CMP_CERTRESPONSE_get_certificate"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CERTSTATUS_SET_CERTHASH, 0),
     "CMP_CERTSTATUS_set_certHash"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_CAPUBS_GET1, 0),
     "OSSL_CMP_CTX_caPubs_get1"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_CAPUBS_NUM, 0),
     "OSSL_CMP_CTX_caPubs_num"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_CAPUBS_POP, 0),
     "CMP_CTX_caPubs_pop"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_EXTRACERTSIN_NUM, 0),
     "OSSL_CMP_CTX_extraCertsIn_num"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_EXTRACERTSIN_POP, 0),
     "CMP_CTX_extraCertsIn_pop"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_EXTRACERTSOUT_NUM, 0),
     "CMP_CTX_extraCertsOut_num"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_EXTRACERTSOUT_PUSH1, 0),
     "OSSL_CMP_CTX_extraCertsOut_push1"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_CTX_INIT, 0), "CMP_CTX_init"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_GENM_NEW, 0), "OSSL_CMP_genm_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_GENP_NEW, 0), "OSSL_CMP_genp_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKICONF_NEW, 0),
     "OSSL_CMP_pkiconf_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIFREETEXT_PUSH_STR, 0),
     "CMP_PKIFREETEXT_push_str"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIHEADER_GENERALINFO_ITEM_PUSH0, 0),
     "OSSL_CMP_PKIHEADER_generalInfo_item_push0"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIHEADER_INIT, 0),
     "CMP_PKIHEADER_init"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIHEADER_PUSH0_FREETEXT, 0),
     "CMP_PKIHEADER_push0_freeText"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIHEADER_PUSH1_FREETEXT, 0),
     "CMP_PKIHEADER_push1_freeText"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIHEADER_SET_MESSAGETIME, 0),
     "CMP_PKIHEADER_set_messageTime"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIHEADER_SET_VERSION, 0),
     "CMP_PKIHEADER_set_version"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIMESSAGE_CHECK_RECEIVED, 0),
     "OSSL_CMP_PKIMESSAGE_check_received"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIMESSAGE_CREATE, 0),
     "OSSL_CMP_PKIMESSAGE_create"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIMESSAGE_GENERALINFO_ITEMS_PUSH1, 0),
     "OSSL_CMP_PKIMESSAGE_generalInfo_items_push1"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIMESSAGE_GENM_ITEMS_PUSH1, 0),
     "CMP_PKIMESSAGE_genm_items_push1"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIMESSAGE_GENM_ITEM_PUSH0, 0),
     "CMP_PKIMESSAGE_genm_item_push0"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIMESSAGE_HTTP_PERFORM, 0),
     "OSSL_CMP_PKIMESSAGE_http_perform"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKIMESSAGE_PROTECT, 0),
     "OSSL_CMP_PKIMESSAGE_protect"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKISTATUSINFO_PKIFAILUREINFO_GET, 0),
     "OSSL_CMP_PKISTATUSINFO_PKIFailureinfo_get"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKISTATUSINFO_PKISTATUS_GET, 0),
     "OSSL_CMP_PKISTATUSINFO_PKIStatus_get"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKISTATUSINFO_PKISTATUS_GET_STRING, 0),
     "OSSL_CMP_PKISTATUSINFO_PKIStatus_get_string"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_POLLREPCONTENT_POLLREP_GET0, 0),
     "CMP_POLLREPCONTENT_pollRep_get0"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_POLLREP_NEW, 0), "CMP_pollrep_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_POLLREQ_NEW, 0),
     "OSSL_CMP_pollReq_new"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_REVREPCONTENT_PKISTATUSINFO_GET, 0),
     "CMP_REVREPCONTENT_PKIStatusInfo_get"},
...
static const ERR_STRING_DATA CMP_str_reasons[] = {
    ...
    "missing key usage digitalsignatue"},
    ...
    {ERR_PACK(ERR_LIB_CMP, 0, CMP_R_UNSUPPORTED_POPO_METHOD),
