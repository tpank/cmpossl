...
static ERR_STRING_DATA CMP_str_functs[] = {
    ...
    {ERR_FUNC(CMP_F_CMP_REVREPCONTENT_STATUS_GET),
     "CMP_REVREPCONTENT_status_get"},
...
static ERR_STRING_DATA CMP_str_reasons[] = {
    ...
    {ERR_REASON(CMP_R_ENCOUNTERED_REVOCATIONNOTIFICATION),
     "encountered unexpected revocationnotification"},
    {ERR_REASON(CMP_R_ENCOUNTERED_REVOCATIONWARNING),
     "encountered revocationwarning"},
