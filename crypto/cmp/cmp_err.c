...
static const ERR_STRING_DATA CMP_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_HDR_GENERALINFO_ITEMS_PUSH1, 0),
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_MSG_CREATE, 0),
     "OSSL_CMP_MSG_create"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_MSG_GEN_ITAVS_PUSH1, 0),
     "OSSL_CMP_MSG_gen_ITAVs_push1"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_MSG_GEN_ITAV_PUSH0, 0),
