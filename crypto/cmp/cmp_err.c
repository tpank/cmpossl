...
static ERR_STRING_DATA CMP_str_functs[] = {
    ...
    {ERR_FUNC(CMP_F_CMP_CTX_SET1_DIGEST), "CMP_CTX_set1_digest"},
    ...
    {ERR_FUNC(CMP_F_CMP_CTX_SET1_SOURCEADDRESS),
     "CMP_CTX_set1_sourceAddress"},
    ...
    {ERR_FUNC(CMP_F_CMP_PKIMESSAGE_PARSE_ERROR_MSG),
...
static ERR_STRING_DATA CMP_str_reasons[] = {
    ...
    {ERR_REASON(CMP_R_ERROR_NONCES_DO_NOT_MATCH),
     "recipient nonce missing or does not match"},
    {ERR_REASON(CMP_R_ERROR_NO_STATUSSTRING), "error no statusstring"},
