...
static const ERR_STRING_DATA CMP_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_CALC_PROTECTION, 0),
     "CMP_calc_protection"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_CERTREPMESSAGE_GET0_CERTRESPONSE, 0),
     "CMP_CERTREPMESSAGE_get0_certResponse"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_CERTRESPONSE_GET1_CERTIFICATE, 0),
     "CMP_CERTRESPONSE_get1_certificate"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_CTX_SET0_NEWCLCERT, 0),
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXCHANGE_CERTCONF, 0),
     "CMP_exchange_certConf"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_EXCHANGE_ERROR, 0), "CMP_exchange_error"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_PKISTATUS_TO_STRING, 0),
     "CMP_PKIStatus_to_string"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_POLLREPCONTENT_GET0_POLLREP, 0),
     "CMP_POLLREPCONTENT_get0_pollRep"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_REVREPCONTENT_GET_CERTID, 0),
     "CMP_REVREPCONTENT_get_CertId"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_CMP_REVREPCONTENT_GET_PKISTATUSINFO, 0),
     "CMP_REVREPCONTENT_get_PKIStatusInfo"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_GET1_CERT_STATUS, 0), "get1_cert_status"},
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_HDR_GENERALINFO_PUSH0_ITEM, 0),
     "OSSL_CMP_HDR_generalInfo_push0_item"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_HDR_GENERALINFO_PUSH1_ITEMS, 0),
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_HDR_UPDATE_MESSAGETIME, 0),
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_MSG_CREATE, 0),
     "OSSL_CMP_MSG_create"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_MSG_GEN_PUSH0_ITAV, 0),
     "OSSL_CMP_MSG_gen_push0_ITAV"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_MSG_GEN_PUSH1_ITAVS, 0),
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKISI_GET_PKIFAILUREINFO, 0),
     "OSSL_CMP_PKISI_get_PKIFailureInfo"},
    {ERR_PACK(ERR_LIB_CMP, CMP_F_OSSL_CMP_PKISI_GET_PKISTATUS, 0),
    ...
    {ERR_PACK(ERR_LIB_CMP, CMP_F_PROCESS_CERT_REQUEST, 0),
