...
static const ERR_STRING_DATA CRMF_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CRMF, CRMF_F_OSSL_CRMF_MSG_PUSH0_REGCTRL, 0),
     "CRMF_MSG_push0_regCtrl"},
    {ERR_PACK(ERR_LIB_CRMF, CRMF_F_OSSL_CRMF_MSG_PUSH0_REGINFO, 0),
     "CRMF_MSG_push0_regInfo"},
    {ERR_PACK(ERR_LIB_CRMF, CRMF_F_OSSL_CRMF_MSG_SET0_EXTENSIONS, 0),
     "OSSL_CRMF_MSG_set0_extensions"},
    {ERR_PACK(ERR_LIB_CRMF, CRMF_F_OSSL_CRMF_MSG_SET1_ISSUER, 0),
     "OSSL_CRMF_MSG_set1_issuer"},
    {ERR_PACK(ERR_LIB_CRMF, CRMF_F_OSSL_CRMF_MSG_SET1_PUBLICKEY, 0),
     "OSSL_CRMF_MSG_set1_publicKey"},
    {ERR_PACK(ERR_LIB_CRMF, CRMF_F_OSSL_CRMF_MSG_SET1_REGCTRL_OLDCERTID_FROM_CERT, 0),
     "OSSL_CRMF_MSG_set1_regCtrl_oldCertID_from_cert"},
    {ERR_PACK(ERR_LIB_CRMF, CRMF_F_OSSL_CRMF_MSG_SET1_SUBJECT, 0),
     "OSSL_CRMF_MSG_set1_subject"},
