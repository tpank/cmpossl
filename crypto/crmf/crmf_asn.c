...
ASN1_CHOICE(CRMF_ENCRYPTEDKEY) = {
    ASN1_IMP(CRMF_ENCRYPTEDKEY, value.encryptedValue, OSSL_CRMF_ENCRYPTEDVALUE, 0),
    /*
...
ASN1_CHOICE(CRMF_PROOFOFPOSSESION) = {
    ...
    ASN1_IMP(CRMF_PROOFOFPOSSESION, value.signature, OSSL_CRMF_POPOSIGNINGKEY, 1),
...
ASN1_ADB_TEMPLATE(attributetypeandvalue_default) = ASN1_OPT(
        CRMF_ATTRIBUTETYPEANDVALUE, value.other, ASN1_ANY);
ASN1_ADB(CRMF_ATTRIBUTETYPEANDVALUE) = {
    ...
    ADB_ENTRY(NID_id_regInfo_certReq, ASN1_SIMPLE(CRMF_ATTRIBUTETYPEANDVALUE,
                                              value.certReq, OSSL_CRMF_CERTREQUEST)),
} ASN1_ADB_END(CRMF_ATTRIBUTETYPEANDVALUE, 0, type, 0,
...
ASN1_SEQUENCE(OSSL_CRMF_CERTTEMPLATE) = {
    ...
    ASN1_IMP_OPT(OSSL_CRMF_CERTTEMPLATE, validity,     CRMF_OPTIONALVALIDITY, 4),
...
ASN1_SEQUENCE(OSSL_CRMF_CERTREQUEST) = {
    ...
    ASN1_SEQUENCE_OF_OPT(OSSL_CRMF_CERTREQUEST, controls, CRMF_ATTRIBUTETYPEANDVALUE)
...
ASN1_SEQUENCE(OSSL_CRMF_CERTREQMSG) = {
    ...
    ASN1_OPT(OSSL_CRMF_CERTREQMSG, popo, CRMF_PROOFOFPOSSESION),
    ASN1_SEQUENCE_OF_OPT(OSSL_CRMF_CERTREQMSG, regInfo, CRMF_ATTRIBUTETYPEANDVALUE)
