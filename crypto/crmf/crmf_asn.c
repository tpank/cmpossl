...
ASN1_SEQUENCE(OSSL_CRMF_ENCKEYWITHID) = {
    ...
    ASN1_IMP_OPT(OSSL_CRMF_ENCKEYWITHID, identifier, OSSL_CRMF_ENCKEYWITHID_IDENTIFIER,0)
...
ASN1_CHOICE(OSSL_CRMF_ENCRYPTEDKEY) = {
    ASN1_IMP(OSSL_CRMF_ENCRYPTEDKEY, value.encryptedValue, OSSL_CRMF_ENCRYPTEDVALUE, 0),
    /*
...
ASN1_CHOICE(OSSL_CRMF_PROOFOFPOSSESION) = {
    ASN1_IMP(OSSL_CRMF_PROOFOFPOSSESION, value.raVerified, ASN1_NULL, 0),
    ASN1_IMP(OSSL_CRMF_PROOFOFPOSSESION, value.signature, OSSL_CRMF_POPOSIGNINGKEY, 1),
    ASN1_EXP(OSSL_CRMF_PROOFOFPOSSESION, value.keyEncipherment, OSSL_CRMF_POPOPRIVKEY, 2),
    ASN1_IMP(OSSL_CRMF_PROOFOFPOSSESION, value.keyAgreement, OSSL_CRMF_POPOPRIVKEY, 3)
} ASN1_CHOICE_END(OSSL_CRMF_PROOFOFPOSSESION)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CRMF_PROOFOFPOSSESION)
...
ASN1_ADB(OSSL_CRMF_ATTRIBUTETYPEANDVALUE) = {
    ADB_ENTRY(NID_id_regCtrl_regToken, ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
    ...
    ADB_ENTRY(NID_id_regCtrl_pkiPublicationInfo,
              ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
                            value.pkiPublicationInfo, OSSL_CRMF_PKIPUBLICATIONINFO)),
    ADB_ENTRY(NID_id_regCtrl_pkiArchiveOptions,
              ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
                              value.pkiArchiveOptions, OSSL_CRMF_PKIARCHIVEOPTIONS)),
    ADB_ENTRY(NID_id_regCtrl_oldCertID, ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
                                                 value.oldCertID, OSSL_CRMF_CERTID)),
    ADB_ENTRY(NID_id_regCtrl_protocolEncrKey
              , ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
                                           value.protocolEncrKey, X509_PUBKEY)),
    ADB_ENTRY(NID_id_regInfo_utf8Pairs, ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
...
ASN1_SEQUENCE(OSSL_CRMF_CERTREQMSG) = {
    ASN1_SIMPLE(OSSL_CRMF_CERTREQMSG, certReq, OSSL_CRMF_CERTREQUEST),
    ASN1_OPT(OSSL_CRMF_CERTREQMSG, popo, OSSL_CRMF_PROOFOFPOSSESION),
    ASN1_SEQUENCE_OF_OPT(OSSL_CRMF_CERTREQMSG, regInfo, OSSL_CRMF_ATTRIBUTETYPEANDVALUE)
} ASN1_SEQUENCE_END(OSSL_CRMF_CERTREQMSG)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CRMF_CERTREQMSG)


ASN1_ITEM_TEMPLATE(OSSL_CRMF_CERTREQMESSAGES) =
    ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0,
                          OSSL_CRMF_CERTREQMESSAGES, OSSL_CRMF_CERTREQMSG)
    ASN1_ITEM_TEMPLATE_END(OSSL_CRMF_CERTREQMESSAGES)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CRMF_CERTREQMESSAGES)
