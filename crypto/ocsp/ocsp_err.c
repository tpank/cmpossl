...
static const ERR_STRING_DATA OCSP_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQUEST_VERIFY, 0),
     "OCSP_request_verify"},
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQ_CTX_ADD1_HEADER, 0),
     "OCSP_REQ_CTX_add1_header"},
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQ_CTX_ADD1_HTTP, 0),
     "OCSP_REQ_CTX_add1_http"},
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQ_CTX_D2I, 0), "OCSP_REQ_CTX_d2i"},
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQ_CTX_HTTP, 0), "OCSP_REQ_CTX_http"},
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQ_CTX_I2D, 0), "OCSP_REQ_CTX_i2d"},
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQ_CTX_NBIO, 0), "OCSP_REQ_CTX_nbio"},
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQ_CTX_NBIO_D2I, 0),
     "OCSP_REQ_CTX_nbio_d2i"},
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQ_CTX_NEW, 0), "OCSP_REQ_CTX_new"},
    {ERR_PACK(ERR_LIB_OCSP, OCSP_F_OCSP_REQ_CTX_SENDREQ, 0),
     "OCSP_REQ_CTX_sendreq"},
...
static const ERR_STRING_DATA OCSP_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_OCSP, 0, OCSP_R_CONNECT_TIMEOUT), "connect timeout"},
    ...
    {ERR_PACK(ERR_LIB_OCSP, 0, OCSP_R_HTTP_BODY_TOO_LARGE),
    "http body too large"},
    {ERR_PACK(ERR_LIB_OCSP, 0, OCSP_R_HTTP_LINE_TOO_LARGE),
    "http line too large"},
    ...
    {ERR_PACK(ERR_LIB_OCSP, 0, OCSP_R_PUT_HTTP_BODY), "put http body"},
    {ERR_PACK(ERR_LIB_OCSP, 0, OCSP_R_PUT_HTTP_HEADER), "put http header"},
    {ERR_PACK(ERR_LIB_OCSP, 0, OCSP_R_REQUEST_NOT_SIGNED),
    "request not signed"},
    {ERR_PACK(ERR_LIB_OCSP, 0, OCSP_R_REQUEST_TIMEOUT), "request timeout"},
    {ERR_PACK(ERR_LIB_OCSP, 0, OCSP_R_RESPONSE_CONTAINS_NO_REVOCATION_DATA),
    "response contains no revocation data"},
    {ERR_PACK(ERR_LIB_OCSP, 0, OCSP_R_RESPONSE_PARSE_ERROR),
