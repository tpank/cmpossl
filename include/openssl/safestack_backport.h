...
# define SKM_DEFINE_STACK_OF(t1, t2, t3) \
    ...
    *sk_##t1##_new_reserve(sk_##t1##_compfunc compare, int n) \
    ...
    sk_##t1##_pop_free(STACK_OF(t1) *sk, sk_##t1##_freefunc freefunc) \
    { \
    ...
    *sk_##t1##_deep_copy(const STACK_OF(t1) *sk, \
    ...
    sk_##t1##_set_cmp_func(STACK_OF(t1) *sk, sk_##t1##_compfunc compare) \
    { \
        return (sk_##t1##_compfunc) \
            OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, \
 ...
 */
typedef void *OPENSSL_BLOCK__unused;
DEFINE_SPECIAL_STACK_OF(OPENSSL_BLOCK__unused, void)
