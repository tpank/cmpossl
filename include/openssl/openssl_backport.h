...
#define ASN1_item_sign_ex(it, algor1, algor2, signature, data, id, pkey, md, libctx, propq) \
    ASN1_item_sign(it, algor1, algor2, signature, (void *)(data), (EVP_PKEY *)pkey, ((void)(id), (void)(libctx), (void)(propq), md))
#define ASN1_item_verify_ex(it, alg, signature, data, id, pkey, libctx, propq) \
    ASN1_item_verify(it, alg, signature, data, ((void)(id), (void)(libctx), (void)(propq), pkey))
#define X509_REQ_verify_ex(a, r, libctx,propq) X509_REQ_verify(a, ((void)(libctx), (void)(propq), r)) 
#define X509_PUBKEY_eq(a, b) ((a)==(b) || ((a)!=NULL&&(b)!=NULL&&EVP_PKEY_cmp(X509_PUBKEY_get0(a), X509_PUBKEY_get0(b))==0))
#define EVP_PKEY_CTX_new_from_pkey(libctx, pkey, propq) EVP_PKEY_CTX_new(((void)(libctx), (void)(propq), pkey), NULL)
...
#define EVP_MD_fetch(ctx, alg, prop) ((EVP_MD *)EVP_get_digestbynid(((void)ctx, (void)(prop), OBJ_sn2nid(alg))))
...
# define ERR_peek_last_error_all(file, line, func, data, flags) ERR_peek_last_error_line_data(file, line, ((*func = ""), data), flags)
# define ERR_get_error_all(file, line, func, data, flags) ERR_get_error_line_data(file, line, ((*func = ""), data), flags)
